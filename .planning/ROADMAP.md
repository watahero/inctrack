...
- [x] 01-03-PLAN.md — The `addon:` suite, the FIX-01 and FIX-02 expected failures, and the exactly-three guard
...
- [x] 02-01-PLAN.md — FIX-01 and FIX-02 in `state.lua`: one author for the
...
- [x] 02-02-PLAN.md — FIX-03 in `ui.lua` and `inctrack.lua`: the unreachable
...
- [x] 03-01-PLAN.md — HARD-01: `ui.render` called through a `pcall` in the frame
...
- [x] 03-02-PLAN.md — HARD-02/03/04: the boss split anchored on the last ` at (`
...
- [x] 03-03-PLAN.md — HARD-05/06: a structural validator that discards a
...
- [x] 04-02-PLAN.md — PERF-02/03: the settings write marked on the chat thread
