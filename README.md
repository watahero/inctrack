...
- **Boons** chosen between phases, one per line with their stats in the usual
  shorthand (`Acc`, `DA`, `STP`, `DT`, `MAB`, `FC`...). They last the whole run,
  and survive a reload with the rest of it.
